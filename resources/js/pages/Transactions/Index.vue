    ...
    <AppLayout :breadcrumbs="breadcrumbs">            
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full lg:w-auto">
                    <button v-if="activeTab === 'in' && startDate && userRole !== 'viewer'" @click="exportDailyInReport" class="w-full sm:w-auto justify-center py-3 sm:py-2 px-4 bg-emerald-600 text-white text-[10px] font-black rounded-lg hover:bg-emerald-700 uppercase flex items-center gap-2 shadow-md shadow-emerald-100 transition-colors">
                        <Download class="w-3.5 h-3.5" /> Export Daily In
                    </button>
                    <button v-if="filterDept && userRole !== 'viewer'" @click="exportDepartmentReport" class="w-full sm:w-auto justify-center py-3 sm:py-2 px-4 bg-blue-600 text-white text-[10px] font-black rounded-lg hover:bg-blue-700 uppercase flex items-center gap-2 shadow-md shadow-blue-100 transition-colors">
                        <Download class="w-3.5 h-3.5" /> Dept Report
                    </button>
                    <Link v-if="userRole !== 'viewer'" :href="route('web.transactions.stock-in')" class="w-full sm:w-auto justify-center py-3 sm:py-2 px-4 bg-emerald-600 text-white text-[10px] font-black rounded-lg uppercase tracking-widest flex items-center gap-2 hover:bg-emerald-700 shadow-md transition-colors">
                        <PackagePlus class="w-3.5 h-3.5" /> Stock In
                    </Link>
                    <Link v-if="userRole !== 'viewer'" :href="route('web.transactions.stock-out')" class="w-full sm:w-auto justify-center py-3 sm:py-2 px-4 bg-slate-900 text-white text-[10px] font-black rounded-lg uppercase tracking-widest flex items-center gap-2 hover:bg-slate-800 shadow-md transition-colors">
            ...
            <!-- Filters Section -->
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-200">
            ...
            <Card class="card-outline p-0 rounded-2xl overflow-hidden">
